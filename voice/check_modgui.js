...
if (typeof fn === 'function') {
    ...
    try {
        ...
        fn({ type: 'change', icon: icon, symbol: 'diag', value: 515306 }, funcs);
        ...
        say('and how long a hold the plugin has ever been shown',
            lu.indexOf('maintien vu jusqu a 0.5 s') >= 0, lu);
