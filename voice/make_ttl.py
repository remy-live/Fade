...
TAIL = [
 ...
 ("in", "fav_browse", "FAV BROWSE", 0.0, 1.0, 0.0, None,
  ...
  "sound: one press steps to the next and the switch says its name, TWO "
  "presses together go there. A press is held back a third of a second to "
  "see whether a second follows, which is the price of one switch doing "
  "both with nothing but presses to work with - a long press cannot be "
  "seen at all on this machine. Twelve seconds without a press and it "
 ...
 ("out", "diag", "DIAG", 0.0, 9999999.0, 0.0, None, [],
  ...
  "Seven digits. The first two are the SHORTEST gap ever seen between two "
  "presses of FAV BROWSE, in hundredths of a second, 99 if no two have "
  "ever landed close together - which says whether two presses can be "
  "told from one on this machine. A long press cannot: the host sends one "
  "pulse however long the foot stays down, which is measured, not "
  "supposed. The third is 1 once "
